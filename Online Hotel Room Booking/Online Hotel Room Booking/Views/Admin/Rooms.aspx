<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Admin/AdminMaster.Master" AutoEventWireup="true" CodeBehind="Rooms.aspx.cs" Inherits="Online_Hotel_Room_Booking.Views.Admin.Rooms" EnableEventValidation="false" %>
        ...
        <div class="row">
            <div class="col-mp-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="LocationTb" required="required" runat="server">
                    </div>
                    <div class="mb-3">
                        <label for="CostTb" class="form-label">Room Cost</label>
                        <input type="text" class="form-control" id="CostTb" required="required" runat="server">
                    </div>
                    <div class="mb-3">
                        <label for="RemarksTb" class="form-label">Remarks</label>
                        <input type="text" class="form-control" id="RemarksTb" required="required" runat="server">
                    </div>
                    <div class="mb-3">
